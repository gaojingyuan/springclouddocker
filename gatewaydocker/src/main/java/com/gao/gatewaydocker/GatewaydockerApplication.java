package com.gao.gatewaydocker;

import com.gao.gatewaydocker.filter.GatewayCheckFilter;
...
@EnableEurekaClient
@RestController
@MapperScan("com.gao.gatewaydocker.mapper")
public class GatewaydockerApplication {

    public static void main(String[] args) {
        SpringApplication.run(GatewaydockerApplication.class, args);
    }
